...
// Time-stamp: <2020-01-09 11:34:59 (snwebb)>
...
void HiggsInvisible::CalculateVariables(){
  ...
  //   std::cout << GenJet_eta[g] << std::endl;
  // }
  // std::cout << "-1-" << std::endl;
  ...
  // std::cout << "--------" << std::endl;
  // std::cout <<     _event_variables["gen_mjj"] << " - " <<     _event_variables["gen_detajj"] << " - " <<     _event_variables["gen_dphijj"] << std::endl;
  // std::cout <<     gen_mjj << " - " <<     gen_detajj << " - " <<     gen_dphijj << std::endl;
    // std::cout << GenJet_pt_or.size() << std::endl;
    // std::cout << GenJet_eta_or.size() << std::endl;
    // std::cout << GenJet_phi_or.size() << std::endl;
    // std::cout << GenJet_mass_or.size() << std::endl;

  // std::cout << "-2-" << std::endl;
  // for (unsigned int g = 0; g < GenJet_eta_or.size(); g++){
  //   std::cout << GenJet_eta_or[g] << std::endl;
  // }
  // std::cout << "-2-" << std::endl;
}
